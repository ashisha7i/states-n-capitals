...
function render_template(template_name, context) {
    var templateHtml = document.getElementById(template_name).innerHTML;
    var tmplt = Handlebars.compile(templateHtml);

    let tempNode = document.createElement("div");
    tempNode.innerHTML = tmplt(context);

    // Clear the utput div first
    let div = document.getElementById("output");
    while(div.firstChild){
        div.removeChild(div.firstChild);
    }

    // Replace the contents of target div with the rendered data
